<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="Create Sales.aspx.cs" Inherits="Create_Sales" %>
     ...
     <div>
            ...
            <div class="input-group">
                <div class="form-inline">    
                    <h3 class="alert alert-info">Add New Authorize Salers</h3>          
                    <table border="0" class="table bg-success ">
                        <tr>
                            <td>
                                <span>User Name</span>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox runat="server" ID="txtStudentId" class="form-control" placeholder="User Name" required="required"  CssClass="form-control"/>
                            </td>
                            <td>
                                 <asp:TextBox runat="server" ID="txtStudentName" class="form-control" placeholder="Password" required="required" CssClass="form-control"/>
                            </td>
                            <td>
