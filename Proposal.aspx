<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="Proposal.aspx.cs" Inherits="Proposal" %>
    ...
    <div>
            ...
            <div class="input-group" style="text-align:center">
                <div class="form-inline">    
                    ...
                    <table border="0"  class="table bg-success table-responsive ">
                         <tr class="alert-info">
                            <td>
                                <span>Name</span>
                            </td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox runat="server" ID="txtName"  placeholder="Proposals Name" required="required"  CssClass="form-control"/>
                            </td>
                            <td>
                                 <asp:TextBox runat="server" ID="txtChance"  placeholder="Chance to Close" required="required" CssClass="form-control"/>
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="txtBudget"  placeholder="Estimated Budget" required="required"  CssClass="form-control"/>
                            </td>
                            <td>
                                 <asp:TextBox runat="server" ID="txtAmount"  placeholder="eg: 2.45" required="required"  CssClass="form-control"/>
                              
                            </td>
                             <td>
                                <asp:TextBox runat="server" ID="txtDuration"  placeholder="Duration in days" required="required"  CssClass="form-control"/>
                            </td>
                             <td>
                                 <asp:TextBox runat="server" ID="txtRevenue"  placeholder="Total Revenue" required="required"  CssClass="form-control"/>
                            </td>
                             </tr>
                        <tr class="alert-info">
                               <td>
                        ...
                        <tr>
                            <td>
                                <asp:TextBox runat="server" ID="txtContactName"  placeholder="Contact Name" required="required"  CssClass="form-control"/>
                            </td>
                            <td>
                                  <asp:TextBox runat="server" ID="txtContactNumber"  placeholder="Contact Number" required="required"  CssClass="form-control"/>
                            </td>
                            <td>
                                <asp:TextBox runat="server" ID="txtDescription"  placeholder="Description" required="required"  CssClass="form-control"/>
                            </td>
                            <td>
                                  <asp:TextBox runat="server" ID="txtNotes"  placeholder="Notes" required="required"  CssClass="form-control"/>
                            </td>
                            <td>
                               <asp:TextBox runat="server" ID="txtReason"  placeholder="Rejection Reason" required="required"  CssClass="form-control"/>
                            </td>
                            <td>
