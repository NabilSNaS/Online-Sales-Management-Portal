    ...
    <div>
            ...
            <div class="input-group">
                <div class="form-inline">    
                    <h3 class="alert alert-info" style="text-align:center">Sales Announcement</h3>          
                    <table border="0"  class="table bg-success ">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:TextBox TextMode="MultiLine" runat="server" ID="txtStudentId" class="form-control" placeholder="Message" required="required"  CssClass="form-control"/>
                            </td>
                            <td>
                                
                                 <asp:TextBox  runat="server" ID="txtStudentName" class="form-control" placeholder="eg: 2016/01/29" required="required" CssClass="form-control"/>
                            </td>
                             <td>
